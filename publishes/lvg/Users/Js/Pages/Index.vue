        ...
        >
            ...
            <template #footer>
                <Button
                    ...
                    icon="pi pi-window"
                    @click="$inertia.visit(route('lvg.auth.users.create'))"
                    class="p-button-text"
                />
                <Button
                    label="Close"
        ...
        >
            ...
            <template #footer>
                <Button
                    ...
                    @click="
                        $inertia.visit(
                            route('lvg.auth.users.show', currentModel)
                        )
                    "
                    class="p-button-text"
                />
        ...
        >
            ...
            <template #footer>
                <Button
                    ...
                    @click="
                        $inertia.visit(
                            route('lvg.auth.users.edit', currentModel)
                        )
                    "
                    class="p-button-text"
                />
...
import Backend from "@Lvg/Core/Js/Layouts/Backend.vue";
import PrimeDatatables from "@Lvg/Core/Js/Components/PrimeDatatables.vue";
...
import CreateForm from "@Lvg/Users/Js/Pages/Partials/CreateForm.vue";
import EditForm from "@Lvg/Users/Js/Pages/Partials/EditForm.vue";
import ShowForm from "@Lvg/Users/Js/Pages/Partials/ShowForm.vue";

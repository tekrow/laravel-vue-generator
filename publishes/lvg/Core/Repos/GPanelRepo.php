...
use Tekrow\Lvg\Helpers\ColumnsReader;
...
class GPanelRepo
{
    ...
    public static function generateBlueprintFromTable(string $tableName, bool $forceRecreate, ?Command $console = null): Schematic
    {
        ...
        \DB::transaction(function() use($tableName,$forceRecreate,$console, &$schematic) {
            ...
            $console?->comment("Creating LvgFields for $schematic->table_name");
            ...
            $schematic->save();
            // BelongsTo LvgRelationships
            $console?->comment("Creating BelongsTo LvgRelationships for $schematic->table_name");
            ...
            $console?->comment("Creating MorphTo LvgRelationships for $schematic->table_name");

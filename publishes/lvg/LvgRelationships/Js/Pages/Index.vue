        ...
        >
            ...
            <template #footer>
                <Button
                    ...
                    @click="
                        $inertia.visit(
                            route('lvg.g-panel.lvg-relationships.create')
                        )
                    "
                    class="p-button-text"
                />
            ...
            <template #footer>
                <Button
                    ...
                    @click="
                        $inertia.visit(
                            route(
                                'lvg.g-panel.lvg-relationships.show',
                                currentModel
                            )
                        )
                    "
            ...
            <template #footer>
                <Button
                    ...
                    @click="
                        $inertia.visit(
                            route(
                                'lvg.g-panel.lvg-relationships.edit',
                                currentModel
                            )
                        )
                    "
...
const apiUrl = route("api.v1.lvg-relationships.dt");
...
const fetchModel = async (row) => {
    axios
        .get(route("api.v1.lvg-relationships.show", row))
        .then((res) => {
...
const deleteModel = async function (row) {
    try {
        const res = await axios.delete(
            route("api.v1.lvg-relationships.destroy", row as any)
        );
        toast.add({
            severity: "success",

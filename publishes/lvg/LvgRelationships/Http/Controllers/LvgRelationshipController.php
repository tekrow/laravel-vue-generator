...
namespace Lvg\LvgRelationships\Http\Controllers;
...
class LvgRelationshipController extends Controller
{
    ...
    public function index(IndexRequest $request): Response
    {
        ...
        return Inertia::render("LvgRelationships/Js/Pages/Index", compact("can"));
    }
    ...
    public function create(Request $request): Response
    {
        ...
        return Inertia::render("LvgRelationships/Js/Pages/Create", compact("can"));
    }
    ...
    public function show(
        ...
        return Inertia::render("LvgRelationships/Js/Pages/Show", compact("model"));
    }
    ...
    {
        $model = $this->repo->setModel($relationship)->show();
        return Inertia::render("LvgRelationships/Js/Pages/Edit", compact("model"));
    }

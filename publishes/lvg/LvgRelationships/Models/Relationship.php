...
namespace Lvg\LvgRelationships\Models;

use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use Lvg\LvgRelationships\Database\Factories\RelationshipFactory;
use Laravel\Scout\Searchable;

class Relationship extends \Lvg\Core\Models\Relationship
{
    ...
    public function related(): \Illuminate\Database\Eloquent\Relations\BelongsTo
    {
        return $this->belongsTo(
            \Lvg\LvgSchematics\Models\Schematic::class,
            "related_id",
            "id"
        );
    }

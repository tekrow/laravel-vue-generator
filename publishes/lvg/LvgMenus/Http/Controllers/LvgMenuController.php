...
namespace Lvg\LvgMenus\Http\Controllers;
...
class LvgMenuController extends Controller
{
    ...
    public function index(IndexRequest $request): Response
    {
        ...
        return Inertia::render("LvgMenus/Js/Pages/Index", compact("can"));
    }
    ...
    public function create(Request $request): Response
    {
        ...
        return Inertia::render("LvgMenus/Js/Pages/Create", compact("can"));
    }
    ...
    public function show(ViewRequest $request, Menu $menu): Response
    {
        ...
        return Inertia::render("LvgMenus/Js/Pages/Show", compact("model"));
    }
    ...
    {
        $model = $this->repo->setModel($menu)->show();
        return Inertia::render("LvgMenus/Js/Pages/Edit", compact("model"));
    }

        ...
        >
            ...
            <template #footer>
                <Button
                    ...
                    icon="pi pi-window"
                    @click="
                        $inertia.visit(route('lvg.g-panel.lvg-menus.create'))
                    "
                    class="p-button-text"
                />
                <Button
        ...
        >
            ...
            <template #footer>
                <Button
                    ...
                    @click="
                        $inertia.visit(
                            route('lvg.g-panel.lvg-menus.show', currentModel)
                        )
                    "
                    class="p-button-text"
                />
        ...
        >
            ...
            <template #footer>
                <Button
                    ...
                    @click="
                        $inertia.visit(
                            route('lvg.g-panel.lvg-menus.edit', currentModel)
                        )
                    "
                    class="p-button-text"
                />
...
const apiUrl = route("api.v1.lvg-menus.dt");
...
const fetchModel = async (row) => {
    axios
        .get(route("api.v1.lvg-menus.show", row))
        .then((res) => {
...
const deleteModel = async function (row) {
    try {
        const res = await axios.delete(
            route("api.v1.lvg-menus.destroy", row as any)
        );
        toast.add({
            severity: "success",

...
@endphp
    ...
    public function updateProfile(Request $request)
    {
        ...
        if ($request->ajax()) {
            return ['redirect' => url('admin/profile'), 'message' => trans('tekrow/admin-ui::admin.operation.succeeded')];
        }
...
@endphp
    ...
    public function updatePassword(Request $request)
    {
        ...
        if ($request->ajax()) {
            return ['redirect' => url('admin/password'), 'message' => trans('tekrow/admin-ui::admin.operation.succeeded')];
        }

...
@endif
@if($hasDate)
    import LvgDatepicker from "@/LvgComponents/LvgDatepicker.vue";
@endif
@if($hasInput)
    import JetInput from "@/Jetstream/Input.vue";
@endif
@if($hasTextArea)
    import LvgTextarea from "@/LvgComponents/LvgTextarea.vue";
@endif
@if($hasSelect)
    import InfiniteSelect from '@/LvgComponents/InfiniteSelect.vue';
@endif
    ...
    export default defineComponent({
        ...
        components: {
            ...
            JetInputError,
            JetLabel,
            @if($hasDate) LvgDatepicker,{{"\r"}}@endif
            @if($hasInput) JetInput,{{"\r"}}@endif
            @if($hasCheckbox) JetCheckbox,{{"\r"}}@endif
            @if($hasTextArea) LvgTextarea,{{"\r"}}@endif

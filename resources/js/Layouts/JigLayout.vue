...
<script>
import NavbarComponent from "@/Layouts/Lvg/Navbar.vue";
import SidebarComponent from "@/Layouts/Lvg/Sidebar.vue";
import LvgNotifications from "@/LvgComponents/LvgNotifications.vue";
...
import menu from "@/Layouts/Lvg/Menu.json";

<?php namespace Tekrow\LaravelVueGenerator\Generators;

use Doctrine\DBAL\Schema\ForeignKeyConstraint;
use Tekrow\LaravelVueGenerator\Generators\Traits\FileManipulations;
...
class Controller extends ClassGenerator {
     ...
     * @var string
     */
    protected $name = 'lvg:generate:controller';
    ...
    public function handle()
    {
        ...
        if ($this->generateClass($force)){
            ...
            $icon = "far fa-clone";
            $path = resource_path("js/Layouts/Lvg/Menu.json");
            if (file_exists($path)) {

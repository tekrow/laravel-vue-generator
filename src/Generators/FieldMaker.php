...
class FieldMaker
{
    ...
    public function getComponentImport() {
        return match ($this->field->html_type) {
            ...
            FormFields::SELECT => "import LvgRichSelect from '@/Components/LvgRichSelect.vue';",
            FormFields::DATETIME, FormFields::DATE => "import LvgDatepicker from '@/Components/LvgDatepicker.vue';",
            default => null,
        };
    }
}

<?php namespace Tekrow\LaravelVueGenerator\Generators\Traits;

use Tekrow\LaravelVueGenerator\Generators\Controller;
use Tekrow\LaravelVueGenerator\Generators\Model;

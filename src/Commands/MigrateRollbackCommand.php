...
use Tekrow\Lvg\Migrations\Migrator;
use Tekrow\Lvg\Traits\MigrationLoaderTrait;
...
class MigrateRollbackCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'lvg:migrate-rollback';
    ...
    /**
     * @var \Tekrow\Lvg\Contracts\RepositoryInterface
     */
    protected $module;
    ...
    public function handle() : int
    {
        ...
        foreach ($this->module->getOrdered($this->option('direction')) as $module) {
            $this->line('Running for lvg: <info>' . $module->getName() . '</info>');

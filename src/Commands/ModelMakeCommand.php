...
class ModelMakeCommand extends GeneratorCommand
{
    ...
    private function handleOptionalMigrationOption()
    {
        if ($this->option('migration') === true) {
            ...
            $this->call('lvg:make-migration', ['name' => $migrationName, 'module' => $this->argument('module')]);
        }
    }
            ...
            foreach ($this->schematic->relationships()->where("type","BelongsTo")->get() as $relation) {
                ...
                if ($related) {
                    ...
                    $content .= (new Stub('/partials/belongs-to.stub', [
                        ...
                        "MODEL"     => "\Lvg\\$studlyName\Models\\$relatedModel",
